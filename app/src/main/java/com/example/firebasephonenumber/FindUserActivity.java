...
public class FindUserActivity extends AppCompatActivity {
    ...
    private void getContactList()
    {
        ...
        {
            String name = phones.getString(phones.getColumnIndex(ContactsContract.CommonDataKinds.Phone.PHONETIC_NAME));
            ...
            //foll. line of notifyDataSetChanged not needed here as we r not adding anything to DB here.
    ...
    /*Workaround for country ISO code +91 as when we enter the phone number we generally don't add ISO as we know it for our
    country and call will get generated according to it.*/
